 ...
 * cowpro_customer_cowpro_customer_profile_type_info():
 ...
 *   customer profiles of this type; defaults to cowpro_customer_profile_default_label
 ...
 */
function hook_cowpro_customer_profile_type_info() {
  $profile_types = array();
 ...
 *
 * @see hook_cowpro_customer_profile_type_info()
 */
function hook_cowpro_customer_profile_type_info_alter(&$profile_types){
 ...
 *
 * @see cowpro_customer_profile_uri()
 * @see hook_module_implements_alter()
 * @see entity_uri()
 * @see url()
 */
function hook_cowpro_customer_profile_uri($profile) {
  // No example.
}
 ...
 */
function hook_cowpro_customer_profile_presave($profile) {
  // No example.
}
 ...
 *
 * @see cowpro_order_cowpro_customer_profile_can_delete()
 */
function hook_cowpro_customer_profile_can_delete($profile) {
  // No example.
}
 ...
 * is cowpro_customer_profile_copy_refresh().
 *
 ...
 *
 * @see cowpro_customer_profile_copy_refresh()
 */
function hook_cowpro_customer_profile_copy_refresh_alter(&$commands, $form, $form_state) {
